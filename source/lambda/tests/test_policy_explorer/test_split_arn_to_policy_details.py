...
def test_get_policy_details_from_arn():
    arn = "arn:aws:acm-pca:us-east-2:111111111111:certificate-authorit/942cc890-3671-485f-87e3-a52a39c77591"
    policy_details = get_policy_details_from_arn(arn)
    assert policy_details.get("AccountId") == "111111111111"
    assert policy_details.get("Service") == "acm-pca"
    assert policy_details.get("ResourceIdentifier") == "certificate-authorit/942cc890-3671-485f-87e3-a52a39c77591"
