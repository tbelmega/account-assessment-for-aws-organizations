...
def test_policy_parser_for_policy_with_escape_character():
    ...
    service = "acm-pca"
    resource_identifier = "certificate-authorit/942cc890-3671-485f-87e3-a52a39c77591"
    policy = '{\"Version\":\"2012-10-17\",\"Statement\":[{\"Sid\":\"d5b46682-fe03-4ee3-af97-2cb7b5db2d23-org\",\"Effect\":\"Allow\",\"Principal\":\"*\",\"Action\":\"acm-pca:IssueCertificate\",\"Resource\":\"arn:aws:acm-pca:us-east-2:111111111111:certificate-authorit/942cc890-3671-485f-87e3-a52a39c77591\",\"Condition\":{\"StringEquals\":{\"aws:PrincipalOrgID\":\"o-eci09zojnh\",\"acm-pca:TemplateArn\":\"arn:aws:acm-pca:::template/EndEntityCertificate/V1\"},\"StringNotEquals\":{\"aws:PrincipalAccount\":\"111111111111\"}}},{\"Sid\":\"d5b46682-fe03-4ee3-af97-2cb7b5db2d23-org\",\"Effect\":\"Allow\",\"Principal\":\"*\",\"Action\":[\"acm-pca:DescribeCertificateAuthority\",\"acm-pca:GetCertificate\",\"acm-pca:GetCertificateAuthorityCertificate\",\"acm-pca:ListPermissions\",\"acm-pca:ListTags\"],\"Resource\":\"arn:aws:acm-pca:us-east-2:111111111111:certificate-authorit/942cc890-3671-485f-87e3-a52a39c77591\",\"Condition\":{\"StringEquals\":{\"aws:PrincipalOrgID\":\"o-eci09zojnh\"},\"StringNotEquals\":{\"aws:PrincipalAccount\":\"111111111111\"}}}]}'
    ...
    assert len(formatted_dynamodb_items) == 2
    assert formatted_dynamodb_items[0]['SortKey'] == 'us-east-2#acm-pca#111111111111#certificate-authorit/942cc890-3671-485f-87e3-a52a39c77591#1'
...
def test_create_sort_key():
    ...
    service = "acm-pca"
    resource_identifier = "certificate-authorit/942cc890-3671-485f-87e3-a52a39c77591"
    expected = "us-east-2#acm-pca#111111111111#certificate-authorit/942cc890-3671-485f-87e3-a52a39c77591#1"
    convert_policy_into_ddb_items = ConvertPolicyIntoDynamoDBItems()
