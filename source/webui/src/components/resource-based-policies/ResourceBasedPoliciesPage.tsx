...
export const ResourceBasedPoliciesPage = () => {
  ...
  return (
    <FullPageAssessmentResultTable
      ...
      description={"Legacy feature. This page displays results of policy scans from Account Assessment v1.0.5 and earlier. For new data, use the Policy Explorer page to browse the results of the periodical scan."}
      data={data}
      loading={loading}
